                  ...
                  <Card className=" shadow border-0">
                    ...
                    <CardBody className="px-lg-5 py-lg-5">
                      ...
                      >
                        <div>
                          <small className="font-weight-bold">
                            Quel niveau de difficulté les participants
                            doivent-ils attendre de l'activité ?
                          </small>
                        </div>
                        <Row className="icon-examples">
                      ...
                      >
                        <div>
                          <small className="font-weight-bold">
                            Est ce que votre expérience n'est pas recommandée
                            aux personnes qui présentent une de ses phobies ? Si
                            oui précisez-les.
                          </small>
                        </div>
                        <Row className="icon-examples">
